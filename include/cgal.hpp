...
typedef CGAL::Triangulation_hierarchy_vertex_base_3<
  CGAL::Alpha_shape_vertex_base_3<K>> Vb_alpha;
typedef CGAL::Alpha_shape_cell_base_3<K> Cb_alpha;
typedef CGAL::Triangulation_data_structure_3<Vb_alpha,
					     Cb_alpha,
					     Concurrency_tag> Tds_alpha;
